...
- **figma-describer** — read-only Figma layout describer that inspects Figma designs via the `figma-use` CLI and returns detailed implementation-ready descriptions with ASCII visual diagrams. Invoke when you need to understand, summarize, compare, or document Figma nodes before implementation.
